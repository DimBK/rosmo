...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card card-primary">
            ...
            <form action="{{ route('admin.organization_structures.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('official_name') is-invalid @enderror" id="official_name" name="official_name" value="{{ old('official_name') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('echelon') is-invalid @enderror" id="echelon" name="echelon" value="{{ old('echelon') }}" placeholder="Contoh: Eselon I, dll">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('parent_id') is-invalid @enderror" id="parent_id" name="parent_id">
                            ...
                            @foreach($allStructures as $struct)
                                <option value="{{ $struct->id }}" {{ old('parent_id') == $struct->id ? 'selected' : '' }}>
