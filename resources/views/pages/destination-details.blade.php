...
@section('body_class', 'destination-details-page')
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="destination-hero" data-aos="fade-up" data-aos-delay="100">
          <div class="hero-image">
            <img src="{{ asset('assets/img/travel/destination-3.webp') }}" alt="Santorini" class="img-fluid">
        ...
        <div class="attractions-section" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="row gy-4">
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
              <div class="attraction-item">
                <div class="attraction-image">
                  <img src="{{ asset('assets/img/travel/destination-3.webp') }}" alt="Oia Village" class="img-fluid">
                </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="attraction-item">
                <div class="attraction-image">
                  <img src="{{ asset('assets/img/travel/destination-7.webp') }}" alt="Red Beach" class="img-fluid">
                </div>
                <div class="attraction-content">
                  <h4>Red Beach</h4>
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="attraction-item">
                <div class="attraction-image">
                  <img src="{{ asset('assets/img/travel/destination-12.webp') }}" alt="Akrotiri Ruins" class="img-fluid">
                </div>
                <div class="attraction-content">
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
              <div class="attraction-item">
                <div class="attraction-image">
                  <img src="{{ asset('assets/img/travel/destination-15.webp') }}" alt="Fira Town" class="img-fluid">
                </div>
                <div class="attraction-content">
                  <h4>Fira Town</h4>
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="attraction-item">
                <div class="attraction-image">
                  <img src="{{ asset('assets/img/travel/destination-18.webp') }}" alt="Wine Tasting" class="img-fluid">
                </div>
                <div class="attraction-content">
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="attraction-item">
                <div class="attraction-image">
                  <img src="{{ asset('assets/img/travel/destination-9.webp') }}" alt="Volcano Tour" class="img-fluid">
                </div>
                <div class="attraction-content">
        ...
        <div class="tours-section" data-aos="fade-up" data-aos-delay="400">
          ...
          <div class="row gy-4">
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div class="tour-card">
                <div class="tour-image">
                  <img src="{{ asset('assets/img/travel/tour-5.webp') }}" alt="Sunset Cruise" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
              <div class="tour-card">
                <div class="tour-image">
                  <img src="{{ asset('assets/img/travel/tour-12.webp') }}" alt="Wine Tour" class="img-fluid">
                  <div class="tour-price">
                    <span>$95</span>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
              <div class="tour-card">
                <div class="tour-image">
                  <img src="{{ asset('assets/img/travel/tour-18.webp') }}" alt="Photography Tour" class="img-fluid">
                  <div class="tour-price">
                    <span>$155</span>
                  </div>
                </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="gallery-item">
                  <img src="{{ asset('assets/img/travel/misc-5.webp') }}" alt="Santorini View" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="gallery-item">
                  <img src="{{ asset('assets/img/travel/misc-12.webp') }}" alt="Santorini Architecture" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="gallery-item">
                  <img src="{{ asset('assets/img/travel/misc-8.webp') }}" alt="Santorini Sunset" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="gallery-item">
                  <img src="{{ asset('assets/img/travel/misc-15.webp') }}" alt="Santorini Beach" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="gallery-item">
                  <img src="{{ asset('assets/img/travel/misc-3.webp') }}" alt="Santorini Culture" class="img-fluid">
                </div>
              </div>
            </div>
